...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/sections/BlogEdit.vue?vue&type=template&id=3438dc86&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('v-container',{staticClass:"mt-10 pt-10 mb-10 pb-10"},[_c('form',[_c('v-row',{staticClass:"mb-n6"},[_c('v-col',[_c('v-textarea',{attrs:{"value":_vm.blogData.heading,"label":"heading","dense":"","auto-grow":"","outlined":"","required":""},on:{"input":function($event){_vm.blogData.heading = $event}}}),_vm._v(" "),_c('v-textarea',{attrs:{"label":"subheading","value":_vm.blogData.subheading,"dense":"","auto-grow":"","outlined":"","required":""},on:{"input":function($event){_vm.blogData.subheading = $event}}}),_vm._v(" "),_c('v-col',[_c('v-select',{attrs:{"items":_vm.items,"attach":"","label":"Select Categories","multiple":"","chips":""},on:{"change":_vm.addCategory},model:{value:(_vm.category),callback:function ($$v) {_vm.category=$$v},expression:"category"}})],1),_vm._v(" "),_vm._l((_vm.blogData.description),function(paragraph,index){return _c('div',{key:paragraph.id},[_c('v-textarea',{attrs:{"label":"paragraph","dense":"","value":paragraph.paragraph,"auto-grow":"","outlined":"","rows":"8","row-height":"20"},on:{"input":function($event){_vm.blogData.description[index].paragraph = $event}}})],1)})],2)],1),_vm._v(" "),_c('v-row',[_c('v-col',[_c('v-btn',{staticClass:"my-2",attrs:{"color":"primary"},on:{"click":function($event){return _vm.saveBlog()}}},[_vm._v("SAVE")])],1)],1)],1)])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/sections/BlogEdit.vue?vue&type=template&id=3438dc86&
...
/* harmony default export */ var BlogEditvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    async saveBlog() {
      ...
      try {
        await this.$axios.put(`https://cbsbackend.herokuapp.com/api/blogs/${this.id}`, data, config); // this.getAllMusics()
      } catch (err) {
...
installComponents(component, {SectionsBlogEdit: __webpack_require__(342).default})
