...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/data.vue?vue&type=template&id=4f6c7322&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',[_c('v-container',[_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[_c('v-tabs',{attrs:{"black--text":"","center":"","light":""},model:{value:(_vm.tab),callback:function ($$v) {_vm.tab=$$v},expression:"tab"}},[_c('v-tabs-slider'),_vm._v(" "),_c('v-tab',{staticClass:"ml-20",attrs:{"href":"#products"}},[_vm._v(" Products ")]),_vm._v(" "),_c('v-tab',{attrs:{"href":"#blogs"}},[_vm._v(" Blogs ")]),_vm._v(" "),_c('v-tab',{attrs:{"href":"#stats"}},[_vm._v(" Stats ")])],1),_vm._v(" "),_c('v-tabs-items',{model:{value:(_vm.tab),callback:function ($$v) {_vm.tab=$$v},expression:"tab"}},[_c('v-tab-item',{key:1,attrs:{"value":"products"}},[_c('v-col',{attrs:{"cols":"12","md":"12"}},[_c('h3',{staticClass:"\n                  text-h4 text-center\n                  font-weight-light\n                  mb-xs-4\n                  mt-10\n                  mb-5\n                ",class:_vm.$vuetify.theme.dark ? 'black--text' : 'black--text',staticStyle:{"border-bottom":"2px solid #fde36d","box-shadow":"0 4px 6px -6px #222"}},[_vm._v("\n                PRODUCTS\n              ")])]),_vm._v(" "),_c('div',{staticClass:"container-fluid"},[_c('div',{staticClass:"content",attrs:{"id":"app"}},[_c('form',{on:{"submit":function($event){$event.preventDefault();}}},[_c('table',{directives:[{name:"resize",rawName:"v-resize",value:(_vm.onResize),expression:"onResize"}]},[_c('thead',_vm._l((_vm.headings),function(heading,index){return _c('th',{key:heading[index],staticClass:"table1",attrs:{"align-center":""}},[_vm._v("\n                        "+_vm._s(heading)+"\n                      ")])}),0),_vm._v(" "),_c('tbody',_vm._l((_vm.filteredList),function(item,index){return _c('tr',{key:item},[_c('td',[_c('p',[_vm._v(_vm._s(item.name.toUpperCase()))])]),_vm._v(" "),_c('td',{directives:[{name:"show",rawName:"v-show",value:(!_vm.isMobile),expression:"!isMobile"}]},[_c('p',[_vm._v(_vm._s(item.productId))])]),_vm._v(" "),_c('td',{directives:[{name:"show",rawName:"v-show",value:(!_vm.isMobile),expression:"!isMobile"}]},[_c('p',{staticStyle:{"text-align":"center"}},[_vm._v("\n                            "+_vm._s(item.enquiries)+"\n                          ")])]),_vm._v(" "),_c('td',[_c('v-img',{staticClass:"image grey lighten-2 rounded-lg mt-5 mb-10",attrs:{"src":item.mainImg,"alt":"","width":"50","lazy-src":item.mainImg,"aspect-ratio":"1"}})],1),_vm._v(" "),_c('td',{directives:[{name:"show",rawName:"v-show",value:(!_vm.isMobile),expression:"!isMobile"}]},[_c('p',[_vm._v(_vm._s(item.category))])]),_vm._v(" "),_c('td',[_c('nuxt-link',{attrs:{"to":("/edit/" + (item._id))}},[_vm._v("\n                            Edit\n                          ")])],1),_vm._v(" "),_c('td',[_c('div',{staticClass:"text-center"},[_c('v-dialog',{attrs:{"width":"500"},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
var on = ref.on;
var attrs = ref.attrs;
return [_c('v-btn',_vm._g(_vm._b({staticClass:"btn",attrs:{"color":"red lighten-2","dark":""},on:{"click":function($event){return _vm.showGroup(index)}}},'v-btn',attrs,false),on),[_vm._v("\n                                  X\n                                ")])]}}],null,true),model:{value:(_vm.dialog),callback:function ($$v) {_vm.dialog=$$v},expression:"dialog"}},[_vm._v(" "),_c('v-card',[_c('v-card-title',{staticClass:"text-h5 grey lighten-2"},[_vm._v("\n                                  Delete Product?\n                                ")]),_vm._v(" "),_c('v-card-text',{staticClass:"pt-10"},[_vm._v("\n                                  Are you sure you want to delete this\n                                  product?\n                                ")]),_vm._v(" "),_c('v-divider'),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"primary","text":""},on:{"click":function($event){return _vm.deleteGroup()}}},[_vm._v("YES\n                                  ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"primary","text":""},on:{"click":function($event){_vm.dialog = false}}},[_vm._v("\n                                    NO\n                                  ")])],1)],1)],1)],1)])])}),0)]),_vm._v(" "),_c('div',[_c('v-row',[_c('v-col',{attrs:{"cols":"12","align":"center"}},[_c('v-btn',{staticClass:"btn btn-info yellow float-center mt-20",staticStyle:{"margin-top":"5%","margin-bottom":"5%"},on:{"click":_vm.addGroup}},[_vm._v("\n                          Add Product\n                        ")])],1)],1)],1)]),_vm._v(" "),_c('div',{staticClass:"text-center"})])])],1),_vm._v(" "),_c('v-tab-item',{key:1,attrs:{"value":"blogs"}},[_c('v-col',{attrs:{"cols":"12","md":"12"}},[_c('h3',{staticClass:"\n                  text-h4 text-center\n                  font-weight-light\n                  mb-xs-4\n                  mt-10\n                  mb-5\n                ",class:_vm.$vuetify.theme.dark ? 'black--text' : 'black--text',staticStyle:{"border-bottom":"2px solid #fde36d","box-shadow":"0 4px 6px -6px #222"}},[_vm._v("\n                BLOGS\n              ")])]),_vm._v(" "),_c('div',{staticClass:"container-fluid"},[_c('div',{staticClass:"content",attrs:{"id":"app"}},[_c('form',{on:{"submit":function($event){$event.preventDefault();}}},[_c('table',[_c('thead',_vm._l((_vm.blogHeadings),function(heading,index){return _c('th',{key:heading[index],attrs:{"align-center":""}},[_vm._v("\n                        "+_vm._s(heading)+"\n                      ")])}),0),_vm._v(" "),_c('tbody',_vm._l((_vm.blogList),function(item,index){return _c('tr',{key:item},[_c('td',[_c('p',[_vm._v(_vm._s(item.heading.toUpperCase()))])]),_vm._v(" "),_c('td',{directives:[{name:"show",rawName:"v-show",value:(!_vm.isMobile),expression:"!isMobile"}]},[_c('p',{staticClass:"grey--text",staticStyle:{"font-size":"15px","text-transform":"lowercase"}},[_vm._v("\n                            "+_vm._s(item.info.toLowerCase())+"\n                          ")])]),_vm._v(" "),_c('td',{directives:[{name:"show",rawName:"v-show",value:(!_vm.isMobile),expression:"!isMobile"}]},[_c('p',{staticStyle:{"text-align":"center"}},[_vm._v("\n                            "+_vm._s(item.categories.toString())+"\n                          ")])]),_vm._v(" "),_c('td',[_c('nuxt-link',{attrs:{"to":("/blogEdit/" + (item._id))}},[_vm._v("\n                            Edit\n                          ")])],1),_vm._v(" "),_c('td',[_c('div',{staticClass:"text-center"},[_c('v-dialog',{attrs:{"width":"500"},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
var on = ref.on;
var attrs = ref.attrs;
return [_c('v-btn',_vm._g(_vm._b({staticClass:"btn",attrs:{"color":"red lighten-2","dark":""},on:{"click":function($event){return _vm.showBlogGroup(index)}}},'v-btn',attrs,false),on),[_vm._v("\n                                  X\n                                ")])]}}],null,true),model:{value:(_vm.dialog),callback:function ($$v) {_vm.dialog=$$v},expression:"dialog"}},[_vm._v(" "),_c('v-card',[_c('v-card-title',{staticClass:"text-h5 grey lighten-2"},[_vm._v("\n                                  Delete Blog?\n                                ")]),_vm._v(" "),_c('v-card-text',{staticClass:"pt-10"},[_vm._v("\n                                  Are you sure you want to delete this blog?\n                                ")]),_vm._v(" "),_c('v-divider'),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"primary","text":""},on:{"click":function($event){return _vm.deleteBlogGroup()}}},[_vm._v("YES\n                                  ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"primary","text":""},on:{"click":function($event){_vm.dialog = false}}},[_vm._v("\n                                    NO\n                                  ")])],1)],1)],1)],1)])])}),0)]),_vm._v(" "),_c('div',[_c('v-row',[_c('v-col',{attrs:{"cols":"12","align":"center"}},[_c('v-btn',{staticClass:"btn btn-info yellow float-center mt-20",staticStyle:{"margin-top":"5%","margin-bottom":"5%"},on:{"click":_vm.addBlogGroup}},[_vm._v("\n                          Add Blog\n                        ")])],1)],1)],1)]),_vm._v(" "),_c('div',{staticClass:"text-center"})])])],1)],1)],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/data.vue?vue&type=template&id=4f6c7322&
...
/* harmony default export */ var datavue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    async deleteBlogGroup() {
      ...
      try {
        await this.$axios.delete(`https://cbsbackend.herokuapp.com/api/blogs/${this.blogList[this.blog]._id}`, config);
      } catch (err) {
        throw new Error('Error deleting Product');
      }
    ...
    async addBlogGroup() {
      ...
      try {
        const {
          data
        } = await this.$axios.post('https://cbsbackend.herokuapp.com/api/blogs/', this.$auth.user, config);
        this.getAllBlogs();
        return data;
      } catch (err) {
        throw new Error('Error adding product');
...
var installDirectives = __webpack_require__(350);
