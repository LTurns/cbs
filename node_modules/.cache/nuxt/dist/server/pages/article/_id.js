...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/sections/BlogPage.vue?vue&type=template&id=66c6707d&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{class:_vm.$vuetify.theme.dark ? 'grey darken-4' : 'grey lighten-4',attrs:{"id":"hero"}},[_c('hero-alt',{class:_vm.$vuetify.theme.dark ? 'grey darken-4' : 'white',attrs:{"hero-alt":_vm.heroAlt}}),_vm._ssrNode(" "),(_vm.blogData.heading.length !== 0)?_vm._ssrNode("<div>","</div>",[_c('v-row',{staticClass:"flex-row-reverse",attrs:{"no-gutters":""}},[_c('v-col',{attrs:{"cols":"12","md":"6"}},[_c('div',{staticClass:"pa-lg-16 pa-md-10 px-4 py-15 mt-10"},[_c('h3',{staticClass:"text-h4 text-center font-weight-light mb-xs-4 mb-5",class:_vm.$vuetify.theme.dark ? 'black--text' : 'black--text',staticStyle:{"border-bottom":"2px solid #fde36d","box-shadow":"0 4px 6px -6px #222"}},[_vm._v("\n            "+_vm._s(_vm.blogData.heading)+"\n          ")]),_vm._v(" "),_c('h3',{staticClass:"\n              text-h5 text-uppercase\n              font-weight-thin\n              text-center\n              my-8\n              black--text\n            "},[_vm._v("\n            "+_vm._s(_vm.blogData.subheading)+"\n          ")]),_vm._v(" "),_vm._l((_vm.blogData.description),function(paragraph){return _c('div',{key:paragraph.id},[_c('p',{staticClass:"black--text mt-5",staticStyle:{"line-height":"30px","font-size":"15px","margin-bottom":"20px"}},[_vm._v("\n              "+_vm._s(paragraph.paragraph)+"\n            ")])])})],2)]),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","md":"6"}},_vm._l((_vm.blogData.img),function(image){return _c('div',{key:image.id,staticClass:"align-center",attrs:{"max-height":"400"}},[_c('v-img',{attrs:{"src":image.image,"lazy-src":image.image}})],1)}),0)],1)],1):_vm._ssrNode("<div>","</div>",[_c('v-progress-circular',{staticClass:"text-center",attrs:{"indeterminate":"","color":"amber"}})],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/sections/BlogPage.vue?vue&type=template&id=66c6707d&
...
installComponents_default()(component, {VCol: VCol["a" /* default */],VImg: VImg["a" /* default */],VProgressCircular: VProgressCircular["a" /* default */],VRow: VRow["a" /* default */]})
...
installComponents(component, {SectionsBlogPage: __webpack_require__(338).default})
