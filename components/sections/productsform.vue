<template>
  <v-form>
    ...
    <v-row class="mb-n6">
      <v-col>
        <!-- <select id="select-box" v-model="selectedPerson"> -->
        <!-- <div id="select-button" class="brd">
            <div id="selected-value"><span>Select a platform</span></div>
            <div id="chevrons">
              <i class="fas fa-chevron-up"></i>
              <i class="fas fa-chevron-down"></i>
            </div>
          </div>
          <option v-for="product in products" id="options" :key="product.key">
            {{ product.name }}
          </option>
        </select> -->
        <v-select
